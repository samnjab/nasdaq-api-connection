...
public class NasdaqApiRequest {

    private static final String API_URL = "https://data.nasdaq.com/api/v3/datatables/ZILLOW/DATA.json?api_key=j_bYz4xRRduyMgyH5xMY";
    ...
    public static void main(String[] args) {
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) { // If response code is 200
                ...
                System.out.println("Response from Nasdaq API: ");
